...
# Ensure the users table has the profile_image column (Migration workaround)
try:
    with engine.connect() as conn:
        conn.execute(text("ALTER TABLE users ADD COLUMN profile_image VARCHAR(255) DEFAULT NULL;"))
        conn.commit()
